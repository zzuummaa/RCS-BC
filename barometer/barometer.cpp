...
LPS331::LPS331(void)
{
  ...
  // high
	i2c = new I2C(LPS331AP_ADDRESS_SA0_LOW);
...
{
  i2c->init();
  i2c->writeByte(LPS331_CTRL_REG1, 0b11100000);
  usleep(100 * 1000);
}
...
int32_t LPS331::readPressureRaw(void)
{
  ...
  i2c->readBytes(LPS331_PRESS_OUT_XL, (char*)bytes, 3);
...
int16_t LPS331::readTemperatureRaw(void)
{
  ...
  i2c->readBytes(LPS331_TEMP_OUT_L, (char*)bytes, 2);
